        ...
        paths: {
            ...
            '/api/ai': {
                post: {
                    ...
                    description: 'Sends the requested feature and payload to OpenAI. Requires OPENAI_API_KEY in backend env. No auth by default—secure accordingly.',
                    requestBody: {
                        required: true,
                        content: {
                            'application/json': {
                            ...
                            content: {
                                'application/json': {
                                    ...
                                    example: {
                                        ...
                                        reply: 'Urgency: routine. Likely viral upper respiratory infection. See a primary care doctor if symptoms worsen, last >7 days, or if breathing issues appear.',
                                    },
                                },
                            },
                        },
